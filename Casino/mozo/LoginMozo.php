...
<link rel="stylesheet" href="style.css">
   <head>
    ...
    <div class="main-block">
       <center><img src="logoC.png"width="300"></center>
     <?php error_reporting(0);?>
     <form action="" method="post">
     <hr>
     <center>Ingrese Usuario Mozo</center>
     ...
     <?php
            if ($_POST['btnIngreso']=="Ingresar") {
                    ...
                    $pas = ($_POST['txtContra']);
                    $rs = mysqli_query($cnn, " select * from mozo where Nombre='$nam' AND Contraseña = '$pas'");
                        if ($row = mysqli_num_rows($rs) != 0) {
                            if($row = mysqli_fetch_array($rs)){
                                ...
                                echo "<script type='text/javascript'>window.location='mozoMenu.php'</script>";            
                            }
                            }else{
